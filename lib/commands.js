...
var operations = module.exports.operations = {
  ...
  confirmParameters: function(context) {
    ...
    if (!diff) {
      ...
      console.log('no parameter changes after interview, set skipConfirmParameters to true');
      return context.next();
    }
  ...
  confirmTemplate: function(context) {
    ...
    var diff = coate(context.oldTemplate, context.newTemplate);
    console.log('are templates different in confirmTemplate');
    console.log(diff);
  ...
  confirmChangeset: function(context) {
    if (context.overrides.force || (context.overrides.skipConfirmTemplate && context.overrides.skipConfirmParameters)) {
      console.log('skipping confirmChangeset ....');
      return context.next();
    }
